...
public class TestPageableRepositoryDataProvider
{
    ...
    public void testIterator()
    {
        ...
        PageableRepositoryDataProvider<Person, String> provider = new PageableRepositoryDataProvider<Person, String>(repo, "first", true);
    ...
    public void testSize()
    {
        ...
        PageableRepositoryDataProvider<Person, String> provider = new PageableRepositoryDataProvider<Person, String>(repo, "first");
